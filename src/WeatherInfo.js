        ...
        <h1 className="City">{props.data.city}</h1>
          ...
          <ul className="weather-details">
            ...
            <div className="row">
                ...
                <img src={props.data.iconURL} alt="description" className="me-1" />
                <span className="temperature">{Math.round(props.data.temperature)}</span><span className="temperature-unit mt-3">°C</span>
                </div>
            </div>
